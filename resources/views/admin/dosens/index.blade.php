  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
              <h1>Dosen List</h1>
              <a href="{{ route('admin.dosens.create') }}" class="btn btn-primary mb-3">Create Dosen</a>
                    ...
                    @foreach ($dosens as $dosen)
                      <tr>
                        ...
                        <td class="action-buttons">
                            <a href="{{ route('dosen.showPublic', $dosen->id) }}" class="btn btn-sm btn-info" target="_blank" title="Lihat Profil di Halaman User">
                            See
                            </a>
